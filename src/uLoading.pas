...
type
  TLoading = class
    ...
    public
          class procedure Show(const lay : TLayout; const msg : string);
...
class procedure TLoading.Show(const lay : TLayout; const msg: string);
var
        FService: IFMXVirtualKeyboardService;
begin
        // Panel de fundo opaco...
        Fundo := TRectangle.Create(lay);
        Fundo.Opacity := 0;
        Fundo.Parent := lay;
        Fundo.Visible := true;
